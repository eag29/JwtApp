...
{
    public class GetByIdCategoryQueryHandler : IRequestHandler<GetByIdCategoryQuery, CategoryListDto>
    {
        ...
        public async Task<CategoryListDto> Handle(GetByIdCategoryQuery request, CancellationToken cancellationToken)
        {
